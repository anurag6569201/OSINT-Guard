...
export function MethodologyFooter() {
  ...
  return (
    <footer className="method-section">
      <details className="method-disclosure">
        <summary className="method-disclosure__summary" id="method-heading">
          <span className="method-disclosure__summary-label">Methodology</span>
          <span className="method-disclosure__summary-hint">
            How this report combines public data — click to expand
          </span>
        </summary>
        <div className="method-inner method-inner--disclosure">
          <motion.div
            ref={headerRef}
          ...
          >
            ...
            <h2 className="method-headline">{methodology.headline}</h2>
